...
@dp.table(
    name="finguard.gold.high_value_transactions",
    comment="Transacitons with value higher than the limit configured by the customers"
)
def high_value_transactions() -> DataFrame:
